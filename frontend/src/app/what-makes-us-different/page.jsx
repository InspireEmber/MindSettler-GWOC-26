...
const FeatureDockItem = ({ feature, index }) => {
  return (
    ...
    >
      ...
      <p 
        className="mt-4 text-sm md:text-base text-[#3F2965] font-serif italic max-w-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      >
        "{feature.longDesc}"
      </p>
    </motion.div>
  ...
  return (
    <div className="min-h-screen bg-[#FDFBFD] text-[#5E5A6B] overflow-hidden selection:bg-[#DD1764]/20">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <motion.div style={{ y: bgY }} className="absolute top-[-10%] left-[-15%] w-[60vw] h-[60vw] bg-[#3F2965]/5 rounded-full blur-[100px]" />
        <motion.div style={{ y: bgY }} className="absolute bottom-[-10%] right-[-15%] w-[60vw] h-[60vw] bg-[#DD1764]/5 rounded-full blur-[100px]" />
      </div>

      {/* 2. HERO SECTION */}
      <section className="relative z-10 pt-28 pb-10 md:pt-40 md:pb-16 px-6 text-center">
        <motion.div
          initial="hidden"
          animate="visible"
          variants={fadeInUp}
        ...
        >
          ...
          <h1 className="text-4xl md:text-7xl font-light text-[#2E2A36] mb-6 tracking-tight">
            ...
            <span className="font-serif italic text-[#3F2965] relative inline-block">
              ...
              >
                <path d="M0 4 Q 50 8 100 4" stroke="#DD1764" strokeWidth="2" fill="transparent" />
              </motion.svg>
            </span>
          </h1>
