          ...
          <div className="flex items-center gap-4">
            <Link href="/corporate" passHref>
                <motion.a
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white border border-gray-200 text-sm font-bold text-[#3F2965] shadow-sm hover:bg-[#F6F4FA] transition-colors"
                >
