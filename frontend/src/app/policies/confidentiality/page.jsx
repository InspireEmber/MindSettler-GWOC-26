    ...
    <div className="min-h-screen bg-white text-[#5E5A6B]">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-[#3F2965] to-[#DD1764]">
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">Take the first step toward understanding your mind and building emotional clarity.</p>
          <Link href="/book-session" className="inline-block px-10 py-4 rounded-full bg-white text-[#3F2965] font-medium text-lg hover:bg-white/90 transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95">
