    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-6 py-16">
      <div className="max-w-md w-full border border-[#3F2965]/10 rounded-3xl p-8 bg-[#F6F4FA]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mb-4">
          <div>
            <label className="block text-sm font-medium text-[#2E2A36] mb-1">Full Name</label>
            <input
              type="text"
              name="name"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-[#2E2A36] mb-1">Email</label>
            <input
              type="email"
              name="email"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-[#2E2A36] mb-1">Phone</label>
            <input
              type="tel"
              name="phone"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-[#2E2A36] mb-1">Password</label>
            <input
              type="password"
              name="password"
              required
        ...
        <p className="text-xs text-[#5E5A6B] text-center">
          ...
          <Link href="/login" className="text-[#3F2965] font-medium underline">
            Log in
          </Link>
        </p>
      </div>
