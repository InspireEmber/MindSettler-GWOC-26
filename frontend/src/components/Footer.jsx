...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#2E2A36] text-white py-16 border-t border-[#3F2965]/20">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-[#3F2965] flex items-center justify-center hover:scale-110 transition-transform"
