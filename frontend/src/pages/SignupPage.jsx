  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4 lg:p-0">
      <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-20 items-center relative z-10">
        ...
        {/* Right Side - Signup Form (Identical to original block) */}
        <motion.div
          initial={{ opacity: 0, y: 10, scale: 0.98 }}
          animate={{ opacity: 1, y: 0, scale: 1 }}
          transition={{ duration: 0.4, ease: "easeOut" }}
          className="w-full max-w-lg mx-auto bg-white/10 backdrop-blur-xl border border-white/15 rounded-2xl shadow-2xl overflow-hidden relative z-10 p-8 md:p-10"
        >
          ...
          <p className="text-sm text-gray-300 text-center font-redhat">
            Already have an account?{" "}
            <Link to="/login" className="text-[#eeb9ff] font-medium hover:text-white transition-colors">
              Log in
            </Link>
          </p>
        </motion.div>
