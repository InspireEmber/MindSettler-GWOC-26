  ...
  if (error || !booking) {
    return (
      <div className="min-h-screen py-20 md:py-32 flex flex-col items-center justify-center px-6 text-center relative z-10">
        ...
        <Link to="/book-session" className="px-10 py-4 rounded-full bg-[#eeb9ff] text-[#3F2965] font-serif font-bold shadow-xl shadow-[#eeb9ff]/10 hover:shadow-[#eeb9ff]/20 hover:scale-105 transition-all active:scale-95">
          Try Again
        </Link>
      </div>
    );
