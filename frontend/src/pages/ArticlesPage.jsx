    ...
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      <section className="relative py-16 md:py-24 z-10">
        <div className="max-w-4xl mx-auto px-6">
          <Link to="/resources" className="inline-flex items-center gap-2 text-sm font-medium text-gray-300 hover:text-white hover:gap-3 transition-all mb-8 group relative z-20">
