  ...
  const refreshSessions = async () => {
    try {
      ...
      if (error.message?.includes("User account required")) {
        ...
        // We could redirect aka navigate('/login') or just let it be.
      }
    }
  };
      ...
      <div className="relative z-10 py-12 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-12">
            <SessionSection title="Confirmed Appointments" data={approvedUpcoming} type="approvedUpcoming" navigate={navigate} profile={profile} />
            <SessionSection title="Waiting for Approval" data={pendingUpcoming} type="pendingUpcoming" navigate={navigate} profile={profile} />

            <div className="grid md:grid-cols-2 gap-8">
              <SessionSection title="History" data={completed} type="completed" navigate={navigate} profile={profile} />
              <SessionSection title="Archive" data={rejected} type="rejected" navigate={navigate} profile={profile} />
            </div>
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 self-end md:self-auto">
                  ...
                  <button
                    onClick={() => navigate(`/appointment-status?id=${s._id || s.id}`)}
